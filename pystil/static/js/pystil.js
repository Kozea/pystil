...
(function() {
  ...
  tracker = function() {
    var now, previous_unload, time, track, uuid;

    now = new Date();
    time = now.getTime();
    uuid = (_this.document.cookie.match('pystil=[0-9]+\\$(.+)') || [])[1] || "%s";
    track = {
      _: uuid,
      ...
      l: (_this.document.cookie.match('pystil=([0-9]+)') || [])[1],
